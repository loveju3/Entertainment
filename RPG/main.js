var mapArray,ctx,currentImgMainX,curruentImgMainY;
...
$(document).ready(function(){
    ...
    {
        ctx.drawImage(imgMain,0,0,80,130,currentImgMainX,curruentImgMainY,200,200);
    };
...
$(document).keydown(function(event){
    ...
    switch(event.which){
        case 37:
                ...
                targetImgMainY = curruentImgMainY;
                cutImagePositionX = 175;
                break;
        case 38:
                targetImgMainX = currentImgMainX;
                targetImgMainY = curruentImgMainY-200;
    ...
    if(targetImgMainX<=400 && targetImgMainX>=0 && targetImgMainY<=400 && targetImgMainY>=0)
        ...
        ctx.clearRect(currentImgMainX,curruentImgMainY,200,200);
            ...
            else
            {
                ...
                curruentImgMainY=targetImgMainY;
            }
            ctx.drawImage(imgMain,cutImagePositionX,0,80,130,currentImgMainX,curruentImgMainY,200,200);
